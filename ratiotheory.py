...
Amount(Event),
Amount(Substance),
Archimedean(Amount(Position)),
Archimedean(Amount(Moment)),
Archimedean(Amount(Event)),
Archimedean(Amount(Object)),
Archimedean(Amount(Substance)),
Proportion(Archimedean(Amount(Object)),Archimedean(Amount(Position))),
Proportion(Archimedean(Amount(Event)),Archimedean(Amount(Position))),
Proportion(Archimedean(Amount(Substance)),Archimedean(Amount(Position))),
Proportion(Archimedean(Amount(Position)),Archimedean(Amount(Object))),
Proportion(Archimedean(Amount(Position)),Archimedean(Amount(Event))),
Proportion(Archimedean(Amount(Position)),Archimedean(Amount(Substance))),
ObjectDensity,
EventDensity,
MassDensity,
Proportion(Archimedean(Amount(Object)),Archimedean(Amount(Moment))),
Proportion(Archimedean(Amount(Event)),Archimedean(Amount(Moment))),
Proportion(Archimedean(Amount(Substance)),Archimedean(Amount(Moment))),
Proportion(Archimedean(Amount(Moment)),Archimedean(Amount(Object))),
Proportion(Archimedean(Amount(Moment)),Archimedean(Amount(Event))),
Proportion(Archimedean(Amount(Moment)),Archimedean(Amount(Substance))),
ObjectFrequency,
EventFrequency,
        R1(Position),
        R1(Object),
        R1(Event),
        R1(Amount(Position)),
        R2(Amount(Position), Amount(Position)),
        R2(Amount(Position), Archimedean(Amount(Event))),
        R2(Archimedean(Amount(Event)),Amount(Position)),
        R2(Amount(Position), Archimedean(Amount(Substance))),
        R2(Archimedean(Amount(Substance)), Amount(Position)),
        R2(Amount(Position), Archimedean(Amount(Object))),
        R2(Archimedean(Amount(Object)), Amount(Position)),
        R2(Amount(Position), Proportion(Archimedean(Amount(Substance)),Archimedean(Amount(Position)))),
        R2(Amount(Position), Proportion(Archimedean(Amount(Event)),Archimedean(Amount(Position)))),
        R2(Amount(Position), Proportion(Archimedean(Amount(Object)),Archimedean(Amount(Position)))),
        R2(Proportion(Archimedean(Amount(Substance)), Archimedean(Amount(Position))),Amount(Position)),
        R2(Proportion(Archimedean(Amount(Event)), Archimedean(Amount(Position))),Amount(Position)),
        R2(Proportion(Archimedean(Amount(Object)), Archimedean(Amount(Position))),Amount(Position))
        # R2(Qlt, Reg),
        # R2(Qlt, Qlt),
        # R2(Obj, Reg),
        # R2(Obj, Qlt),
